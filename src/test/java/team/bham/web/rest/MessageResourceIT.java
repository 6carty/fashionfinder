...
class MessageResourceIT {
    ...
    private static final byte[] DEFAULT_MESSAGE_IMAGE = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_MESSAGE_IMAGE = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_MESSAGE_IMAGE_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_MESSAGE_IMAGE_CONTENT_TYPE = "image/png";
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message()
            ...
            .messageImage(DEFAULT_MESSAGE_IMAGE)
            .messageImageContentType(DEFAULT_MESSAGE_IMAGE_CONTENT_TYPE);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message()
            ...
            .messageImage(UPDATED_MESSAGE_IMAGE)
            .messageImageContentType(UPDATED_MESSAGE_IMAGE_CONTENT_TYPE);
        return message;
    }
    ...
    void createMessage() throws Exception {
        ...
        assertThat(testMessage.getMessageImage()).isEqualTo(DEFAULT_MESSAGE_IMAGE);
        assertThat(testMessage.getMessageImageContentType()).isEqualTo(DEFAULT_MESSAGE_IMAGE_CONTENT_TYPE);
    }
    ...
    void getAllMessages() throws Exception {
        ...
        restMessageMockMvc
            ...
            .andExpect(jsonPath("$.[*].messageImageContentType").value(hasItem(DEFAULT_MESSAGE_IMAGE_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].messageImage").value(hasItem(Base64Utils.encodeToString(DEFAULT_MESSAGE_IMAGE))));
    }
    ...
    void getMessage() throws Exception {
        ...
        restMessageMockMvc
            ...
            .andExpect(jsonPath("$.messageImageContentType").value(DEFAULT_MESSAGE_IMAGE_CONTENT_TYPE))
            .andExpect(jsonPath("$.messageImage").value(Base64Utils.encodeToString(DEFAULT_MESSAGE_IMAGE)));
    }
    ...
    void putExistingMessage() throws Exception {
        ...
        assertThat(testMessage.getMessageImage()).isEqualTo(UPDATED_MESSAGE_IMAGE);
        assertThat(testMessage.getMessageImageContentType()).isEqualTo(UPDATED_MESSAGE_IMAGE_CONTENT_TYPE);
    }

    ...
    public ResponseEntity<Calendar> partialUpdateCalendar(
        ...
        Optional<Calendar> result = calendarRepository
            ...
            .map(existingCalendar -> {
                if (calendar.getCurrentWeek() != null) {
                    existingCalendar.setCurrentWeek(calendar.getCurrentWeek());
                }
                if (calendar.getCalendarConnected() != null) {
                    existingCalendar.setCalendarConnected(calendar.getCalendarConnected());
                }
                if (calendar.getCalendarSync() != null) {
                    existingCalendar.setCalendarSync(calendar.getCalendarSync());
                }

        ...
        Optional<Message> result = messageRepository
            ...
            .map(existingMessage -> {
                ...
                if (message.getMessageImage() != null) {
                    existingMessage.setMessageImage(message.getMessageImage());
                }
                if (message.getMessageImageContentType() != null) {
                    existingMessage.setMessageImageContentType(message.getMessageImageContentType());
                }

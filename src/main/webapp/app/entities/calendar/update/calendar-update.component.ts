...
export class CalendarUpdateComponent implements OnInit {
  ...
  userProfilesCollection: IUserProfile[] = [];
  ...
  protected updateForm(calendar: ICalendar): void {
    ...
    this.userProfilesCollection = this.userProfileService.addUserProfileToCollectionIfMissing<IUserProfile>(
    ...
    this.userProfileService
      ...
      .pipe(
        map((userProfiles: IUserProfile[]) =>
          this.userProfileService.addUserProfileToCollectionIfMissing<IUserProfile>(userProfiles, this.calendar?.userProfile)
        )
      )
      .subscribe((userProfiles: IUserProfile[]) => (this.userProfilesCollection = userProfiles));
  }
}

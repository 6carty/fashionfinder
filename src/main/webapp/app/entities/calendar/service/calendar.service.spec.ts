...
import { CalendarService, RestCalendar } from './calendar.service';

const requireRestSample: RestCalendar = {
  ...sampleWithRequiredData,
  currentWeek: sampleWithRequiredData.currentWeek?.toJSON(),
  calendarSync: sampleWithRequiredData.calendarSync?.toJSON(),
};

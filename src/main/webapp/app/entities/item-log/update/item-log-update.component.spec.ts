...
describe('ItemLog Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, RouterTestingModule.withRoutes([]), ItemLogUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const owner: IUser = { id: 5159 };
      itemLog.owner = owner;

      const userCollection: IUser[] = [{ id: 16785 }];
    ...
    it('Should call Outfit query and add missing value', () => {
      const itemLog: IItemLog = { id: 456 };
      const outfit: IOutfit = { id: 17565 };
      itemLog.outfit = outfit;

      const outfitCollection: IOutfit[] = [{ id: 27432 }];
    ...
    it('Should update editForm', () => {
      const itemLog: IItemLog = { id: 456 };
      const owner: IUser = { id: 2803 };
      itemLog.owner = owner;
      const outfit: IOutfit = { id: 21104 };
      itemLog.outfit = outfit;

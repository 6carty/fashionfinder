...
type CommentFormGroupContent = {
  ...
  postCommented: FormControl<CommentFormRawValue['postCommented']>;
  userCommented: FormControl<CommentFormRawValue['userCommented']>;
};
...
export class CommentFormService {
  createCommentFormGroup(comment: CommentFormGroupInput = { id: null }): CommentFormGroup {
    ...
    return new FormGroup<CommentFormGroupContent>({
      ...
      postCommented: new FormControl(commentRawValue.postCommented),
      userCommented: new FormControl(commentRawValue.userCommented),
    });
  }

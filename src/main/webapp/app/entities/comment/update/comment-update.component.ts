...
export class CommentUpdateComponent implements OnInit {
  ...
  protected updateForm(comment: IComment): void {
    ...
    this.postsSharedCollection = this.postService.addPostToCollectionIfMissing<IPost>(this.postsSharedCollection, comment.postCommented);
  ...
  protected loadRelationshipsOptions(): void {
    this.postService
      ...
      .pipe(map((posts: IPost[]) => this.postService.addPostToCollectionIfMissing<IPost>(posts, this.comment?.postCommented)))
    ...
    this.userProfileService
      ...
      .pipe(
        map((userProfiles: IUserProfile[]) =>
          this.userProfileService.addUserProfileToCollectionIfMissing<IUserProfile>(userProfiles, this.comment?.userCommented)
        )
      )
